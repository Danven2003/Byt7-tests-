...
public class Money implements Comparable<Money> {
	...
	public String toString() {
		int integerAmount = amount / 100;
		int decimalNumber = amount % 100;
		return (decimalNumber == 0) ? String.format("%d %s", integerAmount, currency.getName())
				: String.format("%d.%02d %s", integerAmount, decimalNumber, currency.getName());
	}
