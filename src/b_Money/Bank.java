...
public class Bank {
	//remove redundant generic types in HashTable instance
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		// fixed missing negation in the if statement
		if (!accountlist.containsKey(accountid)) {
	 ...
	 */
	//remove useless throwing of Exception that is handled in the catch
	public void tick() {
